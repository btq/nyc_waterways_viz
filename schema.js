/**
* schema - a module that defines the structure of the two tables used to store data.
*
...
exports.samples = {
    ...
    columns: [
        ...
        {name: "no", type: "NUMERIC(5, 3)", description: "nitric monoxide ????? (cm3/m3 [ppm])"},
        {name: "no2", type: "NUMERIC(5, 3)", description: "nitrogen dioxide ????? (cm3/m3 [ppm])"},
        {name: "nox", type: "NUMERIC(5, 3)", description: "nitrogen oxide ????? (cm3/m3 [ppm])"},
        ...
        {name: "spm", type: "NUMERIC(4, 0)", description: "suspended particulate matter (µg/m3)"},
        {name: "pm25", type: "NUMERIC(4, 0)", description: "2.5 micron particulate matter (µg/m3)"}
    ],
